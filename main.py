...
with dataExploration:
    ...
    by_place = pd.read_csv('/Users/akil/Desktop/projectwork/by_place.csv', index_col=[0])
    dist_wise = pd.read_csv('/Users/akil/Desktop/projectwork/dist_wise.csv', index_col=[0])
